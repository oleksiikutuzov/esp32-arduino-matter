 ...
 *  - toggle button (by default attached to GPIO0 - reset button, with
 * debouncing)
 */
...
void setup() {
  ...
  generic_switch_config.switch_cluster.number_of_positions = 1;
  generic_switch_config.switch_cluster.current_position = 0;
  endpoint_t *endpoint = generic_switch::create(node, &generic_switch_config,
